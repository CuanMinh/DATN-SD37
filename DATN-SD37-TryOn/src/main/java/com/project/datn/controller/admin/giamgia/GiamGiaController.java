...
import com.project.datn.service.giamgia.GiamGiaService;
...
public class GiamGiaController {
    ...
    @Autowired
    private GiamGiaService maGiamGiaService;
    ...
    public String capNhatTrangThaiMaGiamGia() {
        maGiamGiaService.capNhatTrangThaiMaGiamGia();
        return "redirect:/admin/giamgia"; // Chuyển hướng về trang danh sách mã giảm giá
    }

    @GetMapping("/ngung-hoat-dong/{id}")
    public String ngungHoatDong(@PathVariable Long id) {
        maGiamGiaService.ngungHoatDong(id);
        return "redirect:/admin/giamgia"; // Chuyển hướng về trang danh sách sau khi cập nhật
    }
